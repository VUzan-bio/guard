...
Usage:
    ...
    python guard-net/scripts/train_discrimination.py --folds 5 --no-neural
...
sys.path.insert(0, str(_PROJECT_ROOT / "guard-net" / "data"))
sys.path.insert(0, str(_PROJECT_ROOT / "guard-net"))
...
def compute_heuristic_baseline(pairs: list) -> dict:
    ...
    guard/scoring/discrimination.py as the baseline.
    """
...
def main():
    ...
    parser.add_argument("--checkpoint-dir", type=str, default="guard-net/checkpoints",
