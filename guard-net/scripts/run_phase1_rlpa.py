...
Usage (from guard/ root):
    python guard-net/scripts/run_phase1_rlpa.py
    python guard-net/scripts/run_phase1_rlpa.py --device cuda
"""
...
# Add guard-net/scripts/../.. to path so run_phase1 is importable
...
def main():
    parser = argparse.ArgumentParser(description="GUARD-Net Phase 1 + RLPA (ablation row 3)")
    parser.add_argument(
        "--data", type=str,
    ...
    parser.add_argument(
        "--pretrained", type=str,
        default="E:/guard-net-data/weights/phase1_rnafm_best.pt",
        help="CNN+RNA-FM checkpoint to transfer weights from",
    )
    parser.add_argument("--output", type=str, default="E:/guard-net-data/weights/phase1_rlpa_best.pt")
    ...
    # --- Summary ---
    print("\n" + "=" * 60)
    print("GUARD-Net Phase 1 + RLPA Results")
    print("=" * 60)
