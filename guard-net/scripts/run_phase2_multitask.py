...
Usage (from guard/ root):
    python guard-net/scripts/run_phase2_multitask.py
    python guard-net/scripts/run_phase2_multitask.py --device cuda
"""
...
def main():
    parser = argparse.ArgumentParser(
        description="GUARD-Net Phase 2 Multi-task (ablation row 4)",
    )
    parser.add_argument(
        "--data", type=str,
    ...
    parser.add_argument("--output", type=str, default="E:/guard-net-data/weights/phase2_multitask_best.pt")
    ...
    from guard_net.data.paired_loader import (
    ...
    from guard_net.training.train_guard_net import (
    ...
    logger.info("GUARDNet: %d params | RNA-FM=True | RLPA=True | MT=True",
    ...
    # --- Summary ---
    print("\n" + "=" * 60)
    print("GUARD-Net Phase 2 Multi-task Results")
    print("=" * 60)
