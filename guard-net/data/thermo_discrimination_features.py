...
_GUARD_NET_DIR = Path(__file__).resolve().parent.parent
if str(_GUARD_NET_DIR) not in sys.path:
    sys.path.insert(0, str(_GUARD_NET_DIR))

_GUARD_DIR = _GUARD_NET_DIR.parent
...
try:
    ...
    from guard.research.thermo_profile import RNA_DNA_NN, INIT_DH, INIT_DS
...
if __name__ == "__main__":
    ...
    from guard_net_data_extract import extract_discrimination_pairs
