"""Active learning loop for GUARD-Net domain adaptation.
...
Workflow:
    ...
    4. Fine-tune GUARD-Net on augmented dataset (Phase 3)
...
def mc_dropout_inference(
    ...
    Args:
        model: GUARDNet (must have dropout layers).
    ...
    for batch in loader:
        ...
        if embedding_cache is not None and "crrna_spacer" in batch:
            from .train_guard_net import _get_batch_embeddings
